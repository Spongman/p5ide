...
declare var QUADS: string;
declare var QUAD_STRIP: string;
declare var CLOSE: string;
declare var OPEN: string;
declare var CHORD: string;
declare var PIE: string;
declare var PROJECT: string;
declare var SQUARE: string;
declare var ROUND: string;
declare var BEVEL: string;
declare var MITER: string;
declare var RGB: string;
declare var HSB: string;
declare var HSL: string;
declare var BLEND: string;
declare var ADD: string;
declare var DARKEST: string;
declare var LIGHTEST: string;
declare var DIFFERENCE: string;
declare var EXCLUSION: string;
declare var MULTIPLY: string;
declare var SCREEN: string;
declare var REPLACE: string;
declare var OVERLAY: string;
declare var HARD_LIGHT: string;
declare var SOFT_LIGHT: string;
declare var DODGE: string;
declare var BURN: string;
declare var THRESHOLD: string;
declare var GRAY: string;
declare var OPAQUE: string;
declare var INVERT: string;
declare var POSTERIZE: string;
declare var DILATE: string;
declare var ERODE: string;
declare var BLUR: string;
declare var NORMAL: string;
declare var ITALIC: string;
declare var BOLD: string;
declare var LANDSCAPE: string;
 ...
 *   here.
 */
declare function loadJSON(path: string, jsonpOptions?: any, datatype?: string, callback?: () => any, errorCallback?: () => any): any|any[];
 ...
 */
declare function loadTable(filename: string, options?: string, callback?: () => any, errorCallback?: () => any): any;
 ...
 */
declare function httpGet(path: string, datatype?: string, data?: any, callback?: () => any, errorCallback?: () => any): void;
 ...
 */
declare function httpPost(path: string, datatype?: string, data?: any, callback?: () => any, errorCallback?: () => any): void;
 ...
 */
declare function httpDo(path: string, method?: string, datatype?: string, data?: any, callback?: () => any, errorCallback?: () => any): void;
 ...
 *   specified in the Fetch API specification.
 */
declare function httpDo(path: string, options: any, callback?: () => any, errorCallback?: () => any): void;
 ...
 */
declare function save(objectOrFilename?: any|string, filename?: string, options?: boolean|string): void;
 ...
 *   fonts instead.
 */
declare function textStyle(theStyle: any): p5;
 ...
 */
declare function select(name: string, container?: string): any|p5.Element|null;
 ...
 */
declare function createImg(src: string, alt?: string, successCallback?: () => any): any|p5.Element;
 ...
 *   body.
 */
declare function createA(href: string, html: string, target?: string): any|p5.Element;
 ...
 */
declare function createSlider(min: number, max: number, value?: number, step?: number): any|p5.Element;
 ...
 *   otherwise appends to body.
 */
declare function createButton(label: string, value?: string): any|p5.Element;
 ...
 */
declare function createCheckbox(label?: string, value?: boolean): any|p5.Element;
 ...
 *   select box
 */
declare function createSelect(existing: any): p5.Element;
 ...
 *   option.
 */
declare function createRadio(divId?: string): any|p5.Element;
 ...
 */
declare function createInput(value?: number, type?: string): any|p5.Element;
 ...
 */
declare function createFileInput(callback?: () => any, multiple?: string): any|p5.Element;
 ...
 *   here and here.
 */
declare function createCapture(type: string|any|any, callback: () => any): any|p5.Element;
